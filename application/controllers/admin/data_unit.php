...
class Data_unit extends CI_Controller {
	...
	public function __construct()
     {
          ...
          $this->load->model('M_data_unit','tb_unit');
	...
	{
		$data['gruppengawas'] = $this->M_daftar_unit->daftar_grup()->result();
		$data['jenis_form'] = $this->M_daftar_unit->jenis_form()->result();
		// $data[''] = $this->M_grup_unit->jenis_form()->result();
		// $this->load->view('welcome_message');
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar');
		$this->load->view('admin/topbar');
		$this->load->view('admin/data_unit',$data);
