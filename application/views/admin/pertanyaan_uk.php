  ...
  <script>
    ...
    function perubahan_form() {
      ...
      $('#id_form').change(function(){
        ...
        $.ajax({
          url:'<?= base_url('admin/pertanyaan_uk/getFormAspek'); ?>',
          method: 'post',
          data: {
            id_form: form
          },
    ...
    function tampil_siswa(parent=0,nama="Home",back="false") {
      $('#tabel-siswa').DataTable({
        ...
        responsive: true,
        ajax: {
          url: "<?= base_url('admin/pertanyaan_uk/get_siswa'); ?>",
          type: "POST",
    ...
    function check_status() {
      switch (status) {
        case 'tambah':
          ...
          url = "<?= base_url('index.php/admin/pertanyaan_uk/save_siswa'); ?>";
          break;
        case 'edit':
          $('#btn-proses').text('Update Changes');
          url = "<?= base_url('index.php/admin/pertanyaan_uk/update_siswa'); ?>";
          break;
        case 'hapus':
          url = "<?= base_url('index.php/admin/pertanyaan_uk/delete_siswa'); ?>";
          break;
        case 'notif' :
        $('#btn-proses').text('Save Changes');
          url = "<?= base_url('index.php/admin/pertanyaan_uk/save_siswa'); ?>";
    ...
    function edit(id_pertanyaan) {
      ...
      clear_form();
      $.ajax({
        url: "<?= base_url('index.php/admin/pertanyaan_uk/edit_siswa'); ?>",
        type: "GET",
        dataType: "JSON",
        data: {
