                              ...
                              <div class="col-lg-11 card border border-left-warning shadow py-5 mx-5 mb-5">
                                ...
                                <div class="form-group text-justify">
                                  <label class="text-danger">Alamat</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Alamat" name="alamat" value="<?php echo $dfn->alamat; ?>" readonly>
                                </div>
                                      ...
                                      <li id="disablecb">Pencatatan/Registrasi
                                        <div class="yatidak">
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="44-50" id="inlineRadio1" value="Ya" onclick="discb('disablecb',false)">
                                            <label class="form-check-label" for="inlineRadio1">Ya</label>
                                          </div>
                                          <div class="form-check form-check-inline ">
                                            <input class="form-check-input" type="radio" name="44-50" id="inlineRadio2" value="Tidak" onclick="discb('disablecb')">
                            ...
                            <fieldset id="no2">
                              <div class="form-card">
                                ...
                                <div class="row py-5">
                                  ...
                                  <div class="form-group">
                                    <div class="col-lg-1">
                                      <input type="checkbox" id="vehicle1" name="45-405" value="" style="width: 30px; height:30px" onclick="disall('no2',1)">               
                                    </div>
                                  </div>
                                </div>
                                          ...
                                          <li class="py-2">Unit Kearsipan menyajikan arsip inaktif untuk kepentingan pengguna internal
                                            ...
                                            <ol class="a mt-2">
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="form-group col-lg-1 mx-3">                
                                                  <input type="checkbox" name="45-75" value="Pengawas Internal" style="width: 20px; height:20px">               
                                                </div>
                                              </div>
                                            </ol>
                                ...
                                <ol class="daftar">
                                  ...
                                  <li class="py-2">Kegiatan Penataan Arsip Inaktif
                                    <ol class="daftar">
                                      ...
                                      <li class="py-2" id="oriradio4">Unit Kearsipan melaksanakan penyusunan daftar arsip inaktif berdasarkan daftar arsip yang dipindahkan dari unit pengolah.
                                        <div class="yatidak">
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="46-85" id="inlineRadio1" value="Ya" onclick="copyradio3('oriradio4','destradio4')">
                                            <label class="form-check-label" for="inlineRadio1">Ya</label>
                                          </div>
                                          <div class="form-check form-check-inline ">
                                            <input class="form-check-input" type="radio" name="46-85" id="inlineRadio2" value="Tidak" onclick="copyradio3('oriradio4','destradio4')">
                                            <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                          </div>
                                        </div>
                                        <div class="col-lg-9 card border-left-info shadow h-100 ">
                                      ...
                                      <li id="destradio4" class="py-2">Daftar arsip inaktif yang disusun oleh Unit Kearsipan telah sesuai dengan ketentuan peraturan perundang-undangan.
                                        ...
                                        <ol class="a mt-1">
                                          <div class="row">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-87" value="pencipta arsip" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-88" value="unit pengolah" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-89" value="nomor arsip" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                                          <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-90" value="kode klasifikasi" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                                          <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-91" value="uraian informasi arsip" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                                          <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-92" value="kurun waktu" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                                          <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-93" value="jumlah" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                                          <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="form-group col-lg-1 mx-3">                
                                              <input type="checkbox" id="vehicle1" name="46-94" value="keterangan" onclick="disradio('destradio4',8)" style="width: 20px; height:20px">               
                                            </div>
                                          </div>
                          ...
                          <div class="form-card">
                            ...
                            <ol class="daftar">
                              <li class="py-2">Pemusnahan
                                <ol class="daftar">
                                  ...
                                  <li class="py-2">Pemusnahan arsip dilaksanakan sesuai prosedur sebagai berikut:
                                    <ol class="daftar">
                                      ...
                                      <li class="py-2" id="oriradio">Terdapat penetapan arsip yang akan dimusnahkan oleh pimpinan satuan kerja rektorat, fakultas, atau satuan kerja <br> dengan sebutan lain, yang dibuktikan dengan adanya keputusan pimpinan satuan kerja rektorat, fakultas, atau satuan kerja <br>dengan sebutan lain di lingkungan Perguruan Tinggi Negeri tentang penetapan pelaksanaan pemusnahan arsip.
                                       <div class="yatidak">
                                        <div class="form-check form-check-inline">
                                          <input class="form-check-input" type="radio" name="47-144" id="inlineRadio1" value="Ya" onclick="copyradio('oriradio','destradio')">
                                          <label class="form-check-label" for="inlineRadio1">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline ">
                                          <input class="form-check-input" type="radio" name="47-144" id="inlineRadio2" value="Tidak" onclick="copyradio('oriradio','destradio')">
                                          <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                        </div>
                                      </div>
                                      <div class="col-lg-9 card border-left-info shadow h-100 ">
                                    ...
                                    <li class="py2" id="destradio">
                                      ...
                                      <ul class=" mt-2">
                                        <div class="row">
                                          ...
                                          <div class="form-group col-lg-1 mx-3">                
                                            <input type="checkbox" id="vehicle1" name="47-146" style="width: 20px; height:20px" onclick="disradio('destradio',2)">               
                                          </div>
                                        </div>
                                        <p>dan/atau</p>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="form-group col-lg-1 mx-3">                
                                            <input type="checkbox" id="vehicle1" name="47-147" value="Bike" style="width: 20px; height:20px" onclick="disradio('destradio',2)">               
                                          </div>
                                        </div>
                                      </ul>
                                ...
                                <li class="py-2" id="oriradio2">Arsip yang tercipta dalam pelaksanaan pemusnahan arsip disimpan oleh Unit Kearsipan pada satuan kerja rektorat, fakultas, atau satuan kerja <br> dengan sebutan lain yang melaksanakan pemusnahan arsip.
                                  <div class="yatidak">
                                    <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="47-154" id="inlineRadio1" value="Ya" onclick="copyradio2('oriradio2','destradio2')">
                                      <label class="form-check-label" for="inlineRadio1">Ya</label>
                                    </div>
                                    <div class="form-check form-check-inline ">
                                      <input class="form-check-input" type="radio" name="47-154" id="inlineRadio2" value="Tidak" onclick="copyradio2('oriradio2','destradio2')">
                                      <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                    </div>
                                  </div>
                                ...
                                <li class="py-2" id="destradio2">Arsip yang tercipta dalam pelaksanaan pemusnahan arsip diperlakukan sebagai arsip vital oleh Unit Kearsipan pada <br> satuan kerja rektorat, fakultas, atau satuan kerja dengan sebutan lain yang melaksanakan pemusnahan arsip.
                                  <div class="yatidak">
                                    <div class="form-check form-check-inline">
                            ...
                            <li class="py-2">Penyerahan
                              ...
                              <ol class="daftar">
                                ...
                                <li class="py-2" id="oriradio3">Arsip yang tercipta dalam pelaksanaan penyerahan arsip statis disimpan oleh Unit Kearsipan pada satuan kerja rektorat, <br> fakultas, atau satuan kerja dengan sebutan lain yang melaksanakan penyerahan arsip statis.
                                  <div class="yatidak">
                                    <div class="form-check form-check-inline">
                                      <input class="form-check-input" type="radio" name="47-172" id="inlineRadio1" value="Ya" onclick="copyradio2('oriradio3','destradio3')">
                                      <label class="form-check-label" for="inlineRadio1">Ya</label>
                                    </div>
                                    <div class="form-check form-check-inline ">
                                      <input class="form-check-input" type="radio" name="47-172" id="inlineRadio2" value="Tidak" onclick="copyradio2('oriradio3','destradio3')">
                                      <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                    </div>
                                  </div>
                                  <div class="col-lg-9 card border-left-info shadow h-100 ">
                                ...
                                <li class="py-2" id="destradio3">Arsip yang tercipta dalam pelaksanaan penyerahan arsip statis diperlakukan sebagai arsip vital oleh Unit Kearsipan <br>pada satuan kerja rektorat, fakultas, atau satuan kerja dengan sebutan lain yang melaksanakan penyerahan arsip statis.
                                  <div class="yatidak">
                                    <div class="form-check form-check-inline">
                              ...
                              <li class="py-2">Dalam Pelaksanaan Fungsi dan Tugasnya, Pimpinan Unit Kearsipan Bertanggungjawab Terhadap
                                ...
                                <ol class="daftar">
                                  ...
                                  <li class="py-2">Monitoring dan Evaluasi
                                    <div class="yatidak">
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="48-181" id="inlineRadio1" value="Ya">
                                        <label class="form-check-label" for="inlineRadio1">Ya</label>
                                      </div>
                                      <div class="form-check form-check-inline ">
                                        <input class="form-check-input" type="radio" name="48-181" id="inlineRadio2" value="Tidak">
                                        <label class="form-check-label" for="inlineRadio2">Tidak</label>
                                      </div>
                                    </div>
                                  </li>
  ...
  function disall(aspek,start){
    ...
    var thisname = list.getElementsByTagName("INPUT")[start-1];
      ...
      for (; i < len; i++) {
          ...
          }else if(list.getElementsByTagName("INPUT")[i].type=="button"){
    ...
    let i = 0;
      ...
      for (; i < len; i++) {
          if(orielem.getElementsByTagName("INPUT")[1].checked==true){
            ...
            destelem.getElementsByTagName("INPUT")[3].disabled=true;
    ...
    let i = 0;
      ...
      for (; i < len; i++) {
          if(orielem.getElementsByTagName("INPUT")[1].checked==true){
            ...
            destelem.getElementsByTagName("INPUT")[2].disabled=true;
            destelem.getElementsByTagName("INPUT")[3].disabled=true;
            destelem.getElementsByTagName("INPUT")[4].disabled=true;
            destelem.getElementsByTagName("INPUT")[5].disabled=true;
            destelem.getElementsByTagName("INPUT")[6].disabled=true;
            destelem.getElementsByTagName("INPUT")[7].disabled=true;
            destelem.getElementsByTagName("INPUT")[8].disabled=true;
            destelem.getElementsByTagName("INPUT")[9].disabled=true;
            destelem.getElementsByTagName("INPUT")[2].checked=false;
            destelem.getElementsByTagName("INPUT")[3].checked=false;
            destelem.getElementsByTagName("INPUT")[4].checked=false;
            destelem.getElementsByTagName("INPUT")[5].checked=false;
            destelem.getElementsByTagName("INPUT")[6].checked=false;
            destelem.getElementsByTagName("INPUT")[7].checked=false;
            destelem.getElementsByTagName("INPUT")[8].checked=false;
            destelem.getElementsByTagName("INPUT")[9].checked=false;
          }else{
            destelem.getElementsByTagName("INPUT")[1].checked=false;
            destelem.getElementsByTagName("INPUT")[0].disabled=true;
            destelem.getElementsByTagName("INPUT")[2].disabled=false;
            destelem.getElementsByTagName("INPUT")[3].disabled=false;
            destelem.getElementsByTagName("INPUT")[4].disabled=false;
            destelem.getElementsByTagName("INPUT")[5].disabled=false;
            destelem.getElementsByTagName("INPUT")[6].disabled=false;
            destelem.getElementsByTagName("INPUT")[7].disabled=false;
            destelem.getElementsByTagName("INPUT")[8].disabled=false;
            destelem.getElementsByTagName("INPUT")[9].disabled=false;
            destelem.getElementsByTagName("INPUT")[2].checked=false;
            destelem.getElementsByTagName("INPUT")[3].checked=false;
            destelem.getElementsByTagName("INPUT")[4].checked=false;
            destelem.getElementsByTagName("INPUT")[5].checked=false;
