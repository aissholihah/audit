    ...
    <!-- container-fluid buat ngisi konten disini yaaa -->
     <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Unit Yang Diawasi</h1>                  
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="<?php echo base_url(). 'admin/unit/tambah_aksi' ?>">
          ...
          <div class="form-group">
            <label>Form </label>
            <!-- <input type="text" name="id_form" class="form-control" required> -->
...
<!-- modal data masukkan data anda -->

<div class="modal fade" id="inputIdentitas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">Masukkan Identitas Anda</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php echo form_open_multipart('user/pengawasan/penyihir'); ?>
                    <form id="formData">
                        <div class="row">
                            <input type="hidden" id="id_pengawas" name="id_pengawas" value="">
                            <div class="col-sm-12">
                                <div class="form-group">
...
function editrow(id){
    ...
    document.getElementById('id_form').value = document.getElementById(id).parentNode.parentNode.childNodes[2].innerHTML;
