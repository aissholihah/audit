<div class="container-fluid">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800 text-primary">REKAPITULASI NILAI AUDIT SISTEM KEARSIPAN INTERNAL  UNIT KEARSIPAN (UK)</h1>
  </div>
  <div class="card shadow mb-4">
    <div class="card-header py-3">
       <?php   
    foreach($history as $vp) :?>
       <h6 class="m-0 font-weight-bold text-primary">Nama Unit : <?php echo $vp->nama_unit; ?></h6>
      <h6 class="m-0 font-weight-bold text-primary">Tanggal Pengawasan Unit : <?php echo $vp->tanggal_audit; ?></h6>     
      <?php endforeach ?>
    </div>
    <div class="card-body">
